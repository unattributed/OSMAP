...
- `maint/security/osmap-v6-evidence-archive.sh` reruns the V6 gate, rejects
  likely secret-bearing inputs, and creates the public-safe archive and
  checksum only after closeout inputs pass.
