...
| --- | --- |
| Existing OSMAP WSTG runner tests | 43 mapped tests |
| Existing explicit gaps | 3 gaps |
| Existing WSTG scenario matrix | WSTG v4.2 |
| WSTG v4.2 scenario rows | 97 |
| WSTG v4.2 rows mapped by current pack | 85 |
| WSTG v4.2 rows not mapped by current pack | 12 |
| WSTG v4.2 rows with explicit Slice 1 disposition | 97 |
| WSTG v4.2 automated dispositions | 60 |
| WSTG v4.2 not-applicable dispositions | 25 |
| WSTG v4.2 blocked dispositions pending due diligence | 12 |
...
- `docs/V3_HTTP_HOST_SMUGGLING_EVIDENCE.md`
- `docs/V3_INJECTION_APPLICABILITY_EVIDENCE.md`
- `OSMAP-WSTG-INPV-004`
- `OSMAP-WSTG-INPV-005`
- `OSMAP-WSTG-INPV-006`
- `OSMAP-WSTG-INPV-007`
...
- raw unauthenticated probes for host-header injection, malformed incoming
  requests, and splitting/smuggling request shapes
- static not-applicable proof for SQL, LDAP, XML, SSI, XPath, code injection,
  format string injection, incubated vulnerability, SSTI, and SSRF classes
...
- bounded public reconnaissance, public app enumeration, framework
  fingerprinting, and web application fingerprinting evidence for INFO-01,
  INFO-04, INFO-08, and INFO-09
