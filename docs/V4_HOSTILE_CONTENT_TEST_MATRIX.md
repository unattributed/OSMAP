...
| allowed external links | preserve only allowed schemes and expose the destination visually in rendered message bodies | V4 CSS destination disclosure |
...
| browser-executable attachments | force download and downgrade risky response types to `application/octet-stream` | V4 attachment tests |
