...
- the current mailbox-helper slice now covers mailbox listing and message-list
  retrieval, but message-view migration and live-host validation through that
  helper are still pending
