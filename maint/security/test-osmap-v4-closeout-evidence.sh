...
for pattern, source_name, source in [
    ...
    (r"All planned V4 roadmap slices have completed for the assessed release claim", "roadmap", roadmap),
    (r"annotated release tag `v4\.0\.0` resolves to evidence bundle commit\s+`59da020`", "roadmap", roadmap),
    ...
    (r"This evidence is carried by the V4 assessed code commit `09a95b7`", "MIME evidence", mime_evidence),
    (r"`v4\.0\.0` evidence bundle at `59da020`", "MIME evidence", mime_evidence),
