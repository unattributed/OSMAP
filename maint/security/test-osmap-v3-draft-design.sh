...
require_text "${repo_root}/config/osmap.env.example" "OSMAP_DRAFT_DIR=/var/lib/osmap/drafts"
require_text "${repo_root}/maint/openbsd/osmap-serve.env.example" "OSMAP_DRAFT_DIR=/var/lib/osmap/drafts"
require_text "${repo_root}/maint/openbsd/osmap-mailbox-helper.env.example" "OSMAP_DRAFT_DIR=/var/lib/osmap-helper/drafts"
require_text "${repo_root}/maint/openbsd/mail.blackbagsecurity.com/etc/osmap/osmap-serve.env" "OSMAP_DRAFT_DIR=/var/lib/osmap/drafts"
require_text "${repo_root}/maint/openbsd/mail.blackbagsecurity.com/etc/osmap/osmap-mailbox-helper.env" "OSMAP_DRAFT_DIR=/var/lib/osmap-helper/drafts"
