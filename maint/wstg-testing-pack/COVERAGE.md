...
| --- | --- | --- | --- |
| `A01:2025` | Broken Access Control | `OSMAP-WSTG-SESS-003`, `OSMAP-WSTG-SESS-004`, `OSMAP-WSTG-INPV-001`, `OSMAP-WSTG-CLNT-001`, `OSMAP-WSTG-CONF-005` | `OSMAP-WSTG-GAP-001` |
...
| `A06:2025` | Insecure Design | `OSMAP-WSTG-CLNT-002`, `OSMAP-WSTG-BUSL-001` | `OSMAP-WSTG-GAP-001`, `OSMAP-WSTG-GAP-002` |
| `A07:2025` | Authentication Failures | `OSMAP-WSTG-ATHN-001`, `OSMAP-WSTG-ATHN-002`, `OSMAP-WSTG-ATHN-003`, `OSMAP-WSTG-ATHN-004`, `OSMAP-WSTG-SESS-001`, `OSMAP-WSTG-SESS-002`, `OSMAP-WSTG-SESS-003`, `OSMAP-WSTG-SESS-005` | none |
| `A08:2025` | Software or Data Integrity Failures | `OSMAP-WSTG-SESS-004`, `OSMAP-WSTG-BUSL-001`, `OSMAP-WSTG-CONF-007` | `OSMAP-WSTG-GAP-001`, `OSMAP-WSTG-GAP-002` |
| `A09:2025` | Security Logging and Alerting Failures | `OSMAP-WSTG-LOGG-001` | none |
| `A10:2025` | Mishandling of Exceptional Conditions | `OSMAP-WSTG-ATHN-003`, `OSMAP-WSTG-CONF-004`, `OSMAP-WSTG-INFO-002`, `OSMAP-WSTG-INPV-001` | none |
...
| `OSMAP-WSTG-CLNT-002` | WSTG-v42-INPV-02 Testing for Stored Cross Site Scripting - HTML email rendering policy | `WSTG-v42-INPV-02`, `WSTG-v42-CLNT-01` | `v5.0.0-1.3.1`, `v5.0.0-1.2.1`, `v5.0.0-3.4.6` | `A05:2025`, `A06:2025` | static review | true | false | false | true | high |
| `OSMAP-WSTG-BUSL-001` | WSTG-v42-BUSL-08 Test Upload of Unexpected File Types - attachment handling policy | `WSTG-v42-BUSL-08`, `WSTG-v42-BUSL-09` | `v5.0.0-10.1.1`, `v5.0.0-10.2.1`, `v5.0.0-14.4.4` | `A06:2025`, `A08:2025` | static review | true | false | false | true | high |
